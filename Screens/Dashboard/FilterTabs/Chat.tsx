...
import { View, Text, Image, ScrollView, StyleSheet, TouchableOpacity, TextInput, Switch,SafeAreaView } from 'react-native';
...
const Chat = () => {
  ...
  const visibleMessages = showFullChat ? messages : messages;

  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
          <TouchableOpacity style={styles.goback} onPress={() => navigation.navigate("WhatsApp")}>
